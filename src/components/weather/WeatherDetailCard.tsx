...
const WeatherDetailCard: React.FC<WeatherDetailCardProps> = ({
    ...
    return (
        ...
        `}>
                ...
                <div>
                    ...
                    <div className="flex items-center gap-3 ml-[30px] mb-[4px]">
                        ...
                        <div className="flex flex-col items-start">
                            <span className={`text-[14px] ${subTextColor} font-[700] tracking-tight`}>Sunrise</span>
                    ...
                    <div className="flex items-center gap-3 ml-[30px]">
                        ...
                        <div className="flex flex-col items-start">
                            <span className={`text-[14px] ${subTextColor} font-[700] tracking-tight`}>Sunset</span>
            ...
            {/* Center: weather icon + condition label */}
            <div className="flex flex-col items-center justify-start pt-2">
                <WeatherIcon condition={condition} size={160} />
                <span className={`${poppins.className} text-[24px] font-[600] tracking-wide -mt-2`}>
                    {condition}
                </span>
            </div>

            {/* Right: detail stats grid */}
            <div className="grid grid-cols-2 gap-x-12 gap-y-4 items-center justify-items-center h-full">
                <div className="flex flex-col items-center mr-[30px]">
                    <svg className={`w-8 h-8 mb-1 ${isLightMode ? 'text-[#292929]' : 'text-white'}`}
                ...
                <div className="flex flex-col items-center mr-[20px]">
                    ...
                    <span className="font-bold text-base">{windSpeed} {speedUnit}</span>
